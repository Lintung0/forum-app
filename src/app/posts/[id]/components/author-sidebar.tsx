        ...
        <div className="p-4 space-y-3">
          <div className="flex items-center gap-3">
            <Link href={`/profile/${post.user?.username}`}>
              <Avatar className="w-10 h-10 border border-[#e95723]/30 cursor-pointer hover:opacity-80 transition-opacity">
            ...
            <div>
              <Link href={`/profile/${post.user?.username}`}>
                <p className="text-sm font-bold text-white tracking-tight hover:text-[#e95723] transition-colors">
