...
export default function RegisterPage() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#1f2937] via-[#283548] to-[#1e293b] flex items-center justify-center px-4 py-6">      <div className="bg-[#162032]/95 backdrop-blur-md border border-blue-400/40 shadow-2xl rounded-3xl w-full max-w-md"
        ...
        <div className="flex flex-col pt-5 pb-1 px-8">
          ...
          <h1 className="text-white text-3xl font-bold tracking-tight text-center w-full mb-2">Daftar</h1>
        </div>
