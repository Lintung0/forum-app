      ...
      <Card className="bg-zinc-900/40 border-zinc-800/80 p-6 md:p-8 rounded-3xl backdrop-blur-md shadow-[0_0_50px_rgba(0,0,0,0.3)] space-y-6">
        <div className="text-center space-y-2">
          ...
          <h1 className="text-2xl font-black tracking-tight text-zinc-100">
            Join <span className="bg-gradient-to-r from-[#e95723] to-[#f59e0b] bg-clip-text text-transparent">Voxra</span> Today
          </h1>
        ...
        <div className="text-center text-xs text-zinc-500 font-light pt-2 border-t border-zinc-800/60">
          Sudah punya akun? <a href="/pages/login" className="text-[#e95723] hover:underline font-medium">Masuk di sini</a>
        </div>
      </Card>
    </AuthLayout>
  );
